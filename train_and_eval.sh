...
TRAIN_SCENARIOS=(training_ghast_pack.json training_wight_pack.json training_archer_mixed.json)
EVAL_SCENARIOS=(eval_mixed_undead.json eval_archer_skirmish.json)
